...
| D IND-3..6 | done | reconciliation+methodology hardening (49721fb); canonical facts+metrics (13b041a); India UI (ac4aad2); 10-issuer corpus with YoY for 7/10, revision cases live (current HEAD) |
| D IND-7..8 | done | narrative corpus 28 docs with page-level citations + commentary labels (4e8c56a); validated India briefs + memo workflow, India eval set 13 cases measured (current HEAD); India roadmap IND-1..IND-8 complete |
